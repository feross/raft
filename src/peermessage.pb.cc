...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "peermessage.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ::google::protobuf::EnumDescriptor* PeerMessage_MessageType_descriptor() {
  protobuf_peermessage_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_peermessage_2eproto::file_level_enum_descriptors[0];
}
...
const int PeerMessage::kSenderIdFieldNumber;
...
PeerMessage::PeerMessage()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_peermessage_2eproto::scc_info_PeerMessage.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* PeerMessage::descriptor() {
  ::protobuf_peermessage_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_peermessage_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const PeerMessage& PeerMessage::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_peermessage_2eproto::scc_info_PeerMessage.base);
...
::google::protobuf::Metadata PeerMessage::GetMetadata() const {
  protobuf_peermessage_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_peermessage_2eproto::file_level_metadata[kIndexInFileMessages];
}
